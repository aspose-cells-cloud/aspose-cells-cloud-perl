...
default: Swagger-Codegen/19.2.1/perl
...
default: https://api.aspose.cloud/v1.1/
...
sub new {
	...
	$p{http_timeout} //= 180;
	$p{http_user_agent} //= 'Swagger-Codegen/19.2.1/perl';
	...
	# base_url
        $p{base_url} //= 'https://api.aspose.cloud/v1.1/';
